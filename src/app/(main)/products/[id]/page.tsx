          ...
          <div className="space-y-6 mb-6">
           ...
           <div className="flex flex-col sm:flex-row items-center gap-4 mb-6 w-full">
              ...
              <div className="flex gap-2 w-full flex-1">
                 <Button size="lg" onClick={handleAddToCart} className="text-base px-6 h-[40px]" style={{width: '80px'}}>
                    <ShoppingBag className="ml-2 h-5 w-5" />
                    أضف إلى السلة
                </Button>
                <Button size="lg" variant="secondary" onClick={handleBuyNow} className="text-base px-6 h-[40px]" style={{width: '70px'}}>
                    اشتري الآن
                </Button>
              </div>
            </div>
