...
export function OfferProductCard({ product }: OfferProductCardProps) {
  ...
  return (
    <div className="bg-white text-black h-full flex flex-col w-full max-w-[180px] mx-auto border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 relative">
      {product.isBestSeller && (
        <div className="absolute top-2 left-2 bg-blue-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-sm z-10">الأكثر مبيعًا</div>
      )}
